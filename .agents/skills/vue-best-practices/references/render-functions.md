...
impact: MEDIUM
impactDescription:
  Render functions require explicit patterns for lists, events, v-model, and performance to stay
...
**Impact: MEDIUM** - Render functions are powerful but opt out of template compiler optimizations.
Use them intentionally and apply the key patterns below to keep output correct and performant.

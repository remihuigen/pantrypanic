...
impact: MEDIUM
impactDescription:
  Poor async component strategy can delay interactivity in SSR apps and create loading UI flicker
type: best-practice
...
**Impact: MEDIUM** - Async components should reduce JavaScript cost without degrading perceived
performance. Focus on hydration timing in SSR and stable loading UX.
...
In Vue 3.5+, async components can delay hydration until idle time, visibility, media query match, or
user interaction.

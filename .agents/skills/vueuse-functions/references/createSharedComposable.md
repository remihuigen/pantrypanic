...
> [!WARNING] When used in a **SSR** environment, `createSharedComposable` will **automatically
> fallback** to a non-shared version. This means every call will create a fresh instance in SSR to
> avoid

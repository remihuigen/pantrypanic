...
You can provide a default value that will be used if the injection key is not provided by a parent
component.
...
You can also create a writable computed property by passing an object with `get` and `set`
functions.

...
Provide web developers with information about the speed of changes for the device's position and
orientation.
...
> Note: For iOS, you need to use `trigger` and bind it with user interaction. After permission
> granted, the API will run automatically
...
You can find
[more information about the state on the MDN](https://developer.mozilla.org/en-US/docs/Web/API/DeviceMotionEvent#instance_properties).

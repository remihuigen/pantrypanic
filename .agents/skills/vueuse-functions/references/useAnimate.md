...
Either an array of keyframe objects, or a keyframe object, or a `ref`. See
...
The third argument accepts a duration number or an options object with the following additional

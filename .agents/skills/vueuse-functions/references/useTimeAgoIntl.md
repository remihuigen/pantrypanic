...
Reactive time ago with i18n supported. Automatically update the time ago string when the time
changes. Powered by `Intl.RelativeTimeFormat`.
...
In case you don't need the reactivity, you can use the `formatTimeAgo` function to get the formatted
